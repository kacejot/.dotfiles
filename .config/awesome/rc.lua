...
local awful         = require("awful")                        -- Widget and layout library
...
run_once({"setxkbmap -layout us,ru -option grp:caps_toggle -variant winkeys", "xrdb ~/.Xresources", "unclutter" }) -- entries must be separated by commas
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "main", "code", "inet", "docs", "chat" }, s, awful.layout.layouts[3])
