...
theme.taglist_font                              = "xos4 Terminus 12"
...
theme.taglist_squares_sel                       = theme.icon_dir .. "/square_sel2.png"
theme.taglist_squares_unsel                     = theme.icon_dir .. "/square_unsel2.png"
...
theme.widget_mem                                = theme.icon_dir .. "/mem3.png"
...
-- Calendar
local mytextcalendar = wibox.widget.textclock(markup.fontfg(theme.font, "#FFFFFF", space3 .. "%d %b " .. markup.font("xos4 Terminus 5", " ")))
...
theme.mpd = lain.widget.mpd({
    settings = function ()
        if mpd_now.state == "play" then
            ...
            widget:set_markup(markup.font("xos4 Terminus 4", " ")
...
theme.fs = lain.widget.fs({
    notification_preset = { bg = theme.bg_normal, font = "xos4 Terminus 9" },
})

-- ALSA volume bar
theme.volume = lain.widget.alsabar({
    notification_preset = { font = "xos4 Terminus 9"},
...
local memory = lain.widget.mem({
    settings = function()
        ...
        widget:set_markup(space3 .. markup.font(theme.font, mem_now.used .. "M") .. markup.font("xos4 Terminus 5", " "))
    end
})
...
local net = lain.widget.net({
    settings = function()
        widget:set_markup(markup.font("xos4 Terminus 1", " ") .. markup.font(theme.font, net_now.received .. " - "
                          .. net_now.sent) .. markup.font("xos4 Terminus 2", " "))
    end
})
...
theme.weather = lain.widget.weather({
    ...
    notification_preset = { font = "xos4 Terminus 9", position = "bottom_right" },
})
...
-- Separators
local first = wibox.widget.textbox('<span font="xos4 Terminus 7"> </span>')
